...
├─ data/                             # Dataset
│  ├─ train/                         # 480 training images organized by class
│  │  ├─ apple/
│  │  ├─ banana/
│  │  ├─ mixed/
│  │  └─ orange/
│  └─ test/                          # 120 test images (flat structure)
│     ├─ apple_77.jpg
│     ├─ banana_77.jpg
│     ├─ mixed_21.jpg
│     └─ orange_77.jpg
├─ experiments/                      # Training results (auto-generated)
│  ├─ notebook_YYYYMMDD_HHMMSS/     # Timestamped experiment folders
│  │  ├─ model_best.h5               # Best trained model
│  │  ├─ history.json                # Training history
│  │  └─ results.json                # Evaluation metrics
│  ├─ prediction_YYYYMMDD_HHMMSS.json     # Single image predictions
│  └─ batch_predictions_YYYYMMDD_HHMMSS.* # Batch results (JSON + CSV)
├─ standalone.py                     # Inference script (NO CONFIG DEPENDENCIES!)
├─ quick_validation.py               # Validation script for all 4 paths
...
# Open Image_Classifier_Training.ipynb in VS Code and run all cells
```
...
# Custom model path
python standalone.py image.jpg --model experiments/notebook_20251130_120000/model_best.h5
```
